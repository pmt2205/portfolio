...
export default function ProjectsSection() {
  return (
    <section id="projects" className="py-20 relative">
      <div className="absolute top-0 right-1/4 -z-10 h-96 w-96 rounded-full bg-cyan-500/5 blur-3xl animate-pulse" />
      
      <Container>
        <SectionTitle title="Featured Projects" subtitle="My Works" />
          ...
          {projects.map((project, index) => (
            ...
            >
              <Card className="flex flex-col h-full overflow-hidden p-0 group">
                ...
                {project.imageUrl && (
                  <div className="relative aspect-video w-full overflow-hidden border-b border-slate-900 bg-slate-950">
                    <Image
                ...
                <div className="flex flex-col justify-between flex-grow p-6">
                  <div>
                    ...
                    <CardContent className="p-0 mt-4 text-slate-400 leading-relaxed text-sm">
                      {project.description}
                    </CardContent>
                  </div>
