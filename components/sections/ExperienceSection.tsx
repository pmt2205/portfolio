...
export default function ExperienceSection() {
  ...
  return (
    <section id="experience" className="py-20 bg-slate-50/40 dark:bg-slate-950/40 relative border-y border-slate-200/50 dark:border-slate-900/50">
      <Container>
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <div className="absolute left-4 top-0 h-full w-0.5 bg-gradient-to-b from-indigo-500 via-cyan-500 to-slate-200 dark:to-slate-950 sm:left-1/2" />
          ...
          {experiences.map((exp, index) => {
            ...
            return (
              ...
              >
                {/* Timeline Node Icon */}
                <div className="absolute left-1.5 top-6 z-10 flex h-6.5 w-6.5 items-center justify-center rounded-full bg-white border-2 border-indigo-500 dark:bg-slate-950 sm:left-1/2 sm:-translate-x-1/2">
                  <Briefcase className="h-3 w-3 text-indigo-500 dark:text-indigo-400" />
                </div>
                  ...
                  <Card className="relative overflow-hidden">
                    ...
                    <CardHeader className="pl-4">
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        ...
                        <div className="flex items-center gap-1.5 rounded-full bg-slate-50 border border-slate-200 px-3 py-1 text-xs text-slate-500 dark:bg-slate-950 dark:border-slate-800 dark:text-slate-400">
                          <Calendar className="h-3.5 w-3.5 text-indigo-500 dark:text-indigo-400" />
                          <span>{exp.time}</span>
                        </div>
                      </div>
                      <CardDescription className="text-indigo-600 dark:text-indigo-400 font-semibold text-sm mt-1">
                        {exp.company}
                      </CardDescription>
                    </CardHeader>
